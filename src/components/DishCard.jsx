      ...
      <div className="flex items-center justify-between gap-3 md:gap-10">
        ...
        <div className="flex items-center gap-3 md:gap-5 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-base md:text-lg font-semibold text-menu-text mb-1 md:mb-2 truncate">{getDishName(dish)}</h3>
            <p className="text-menu-text/70 text-xs md:text-sm leading-relaxed line-clamp-2">
              {getDescription(dish)}
            </p>
